  ...
  return (
    <div className="max-w-md mx-auto bg-[#FF9999] p-8 rounded-3xl shadow-xl border border-[#e9d5ff] mt-10 relative animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 animate-slide-up">
        <div>
          <label className="text-sm font-bold text-[#000000] ml-2">รหัสนักศึกษา</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="text-sm font-bold text-[#000000] ml-2">ชื่อ-นามสกุล</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="text-sm font-bold text-[#000000] ml-2">เกรดเฉลี่ย (GPA)</label>
          <input 
            type="number" 
            step="0.01" 
        ...
        <div>
          <label className="text-sm font-bold text-[#000000] ml-2">รูปโปรไฟล์ (ไม่บังคับ)</label>
          <input 
            type="file" 
            accept="image/*"
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className={`flex-1 text-black font-bold py-4 rounded-2xl shadow-lg transition-all ${
              isLoading ? "bg-[#CC0000]" : "bg-[#CC0000] hover:bg-[#CC0033] active:scale-[0.98]"
            }`}
          >
